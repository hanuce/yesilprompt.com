...
window.AI_ERA = {
  ...
  series: [
    { name: 'NVIDIA',    key: 'nvidia',    values: [0.14, 0.32, 0.73, 0.36, 1.22, 3.28, 4.50, 5.23] },
    ...
    { name: 'T.C. Ekonomi Büyüklüğü (GSYİH)', key: 'trgdp', values: [0.76, 0.72, 0.82, 0.91, 1.12, 1.32, 1.44, 1.55] },
    { name: 'T.C. Merkez Bankası Rezervi',    key: 'trrez', values: [0.11, 0.09, 0.11, 0.13, 0.14, 0.16, 0.17, 0.19] }
  ]
};
